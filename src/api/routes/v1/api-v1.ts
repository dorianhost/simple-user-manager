...
import { updateUserHandler as updateUserHandle } from './user/update-user-handle';
...
v1AuthorizedRouter.get(
  config.routes.v1.user,
  checkRoleMiddleware(UserRole.ADMIN),
  getAllUsersHandler(),
);
